...
#if defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP4_PLATFORM_FW_UPGRADE) || defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP4_BINARY_FW_UPGRADE)
    #define CYTTSP4_FW_UPGRADE 1
#else
    #define CYTTSP4_FW_UPGRADE 0
#endif


#if defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP4_PLATFORM_TTCONFIG_UPGRADE) || defined(CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP4_MANUAL_TTCONFIG_UPGRADE)
    #define CYTTSP4_TTCONFIG_UPGRADE 1
#else
    #define CYTTSP4_TTCONFIG_UPGRADE 0
#endif
